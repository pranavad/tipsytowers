...
//  struct Task* setTask(double startTime, double endTime, const char* mapSpecs, TermType type=sumOfSqrTT, const arr& target=NoArr, double prec=100., uint order=0);
  ...
  void setPlace(double time, const char* endeffRef, const char* object, const char* placeRef, int verbose=2, const char* bound = NULL );
  void setPlaceOne(double time, const char* endeffRef, const char* object, const char* placeRef, int verbose=0, const char* bound = NULL );
  void setPlaceTwo(double time, const char* endeffRef, const char* object, const char* placeRef, int verbose=0, const char* bound = NULL );
  void setPlaceFloating(double time, const char* endeffRef, const char* object, const char* placeRef, int verbose=0, const char* bound = NULL );
  ...
  void step();
  void run(int fileId);
  Graph getReport(bool gnuplt=false, int fileId=100);
  void checkGradients();
